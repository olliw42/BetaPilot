...
//OW CAMERA
        CAMERA_SET_MODE =    198, // set camera mode, high = video mode, low = picture mode
        CAMERA_TRIG_MODE =   199, // set camera mode and trigger/start/stop, high = start video, mid = stop video, low = take picture
//OWEND
